      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid gap-10 lg:grid-cols-2 lg:gap-16 items-center">
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center space-x-2 pt-4">
              <Button variant="outline" size="icon" asChild>
                <Link
                  href="https://github.com/MoazAhmadSE"
                  target="_blank"
                  rel="noopener noreferrer"
                >
              ...
              <Button variant="outline" size="icon" asChild>
                <Link
                  href="https://linkedin.com/in/moaz-ahmad"
                  target="_blank"
                  rel="noopener noreferrer"
                >
          ...
          <div className="flex items-center justify-center">
            <div
              ref={tiltRef}
              className="w-[300px] h-[300px] md:w-[400px] md:h-[400px] relative animate-float overflow-hidden rounded-full border-4 border-secondary shadow-lg bg-background"
            >
              <Image
                src="/3.png"
                alt="Moaz Ahmad"
